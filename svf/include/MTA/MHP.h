...
private:
    ...
    inline const CallGraph::FunctionNodeSet& getCallee(const CallICFGNode* inst, CallGraph::FunctionNodeSet& callees)
    {
...
private:
    ...
    inline const CallGraph::FunctionNodeSet& getCallee(const ICFGNode* inst, CallGraph::FunctionNodeSet& callees)
    {
